...
prompt JSDBD_S1: Creando sinónimos
...
create or replace synonym archivo_programa_f2 for archivo_programa_f2_jsd_s1;
...
create or replace synonym documental_f2 for documental_f2_jsd_s1;
...
create or replace synonym pais_r1 for pais_r_jsd_s1;
...
create or replace synonym pelicula_f2 for pelicula_f2_jsd_s1;
...
create or replace synonym playlist_f3 for playlist_f3_jsd_s1;
...
create or replace synonym programa_f2 for programa_f2_jsd_s1;
...
create or replace synonym serie_f2 for serie_f2_jsd_s1;
create or replace synonym serie_f3 for serie_f3_jsd_s2@jsdbd_s2.fi.unam;

Prompt Creando sinónimos para STATUS_PROGRAMA
create or replace synonym status_programa for status_programa_jsd_s1;
...
create or replace synonym tipo_cuenta_r1 for tipo_cuenta_r_jsd_s1;
...
create or replace synonym tipo_serie_r1 for tipo_serie_r_jsd_s1;
create or replace synonym tipo_serie_r4 for tipo_serie_r_jsd_s2@jsdbd_s2.fi.unam;

Prompt Creando sinónimos para USUARIO
create or replace synonym usuario_f1 for usuario_f1_jsd_s1;
...
create or replace synonym usuario_f4 for usuario_f4_jsd_s1;
create or replace synonym usuario_f5 for usuario_f5_jmp_s2@jmpbd_s2.fi.unam;

Prompt JSDBD_S1: Sinónimos creados existosamente
