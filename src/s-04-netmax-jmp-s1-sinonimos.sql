...
prompt JMPBD_S1: Creando sinónimos
...
create or replace synonym documental_f1 for documental_f1_jmp_s1;
...
create or replace synonym pelicula_f1 for pelicula_f1_jmp_s1;
...
create or replace synonym playlist_f2 for playlist_f2_jmp_s1;
...
create or replace synonym programa_f1 for programa_f1_jmp_s1;
...
create or replace synonym tipo_cuenta_r2 for tipo_cuenta_r_jmp_s2@jmpbd_s2.fi.unam;
...
create or replace synonym tipo_serie_r1 for tipo_serie_r_jmp_s1;
create or replace synonym tipo_serie_r2 for tipo_serie_r_jmp_s2@jmpbd_s2.fi.unam;
...
create or replace synonym usuario_f3 for usuario_f3_jmp_s1;
...
Prompt JMPBD_S1: Sinónimos creados existosamente
